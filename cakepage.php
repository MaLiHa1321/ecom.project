       ...
       <!-- <div class="title-box">
        ...
        <div class="row">
            <div class="col-md-4 py-3 p-3">
                ...
                <img src="image/cake.jfif" alt="" style="width: 15rem; height: 15rem;">
            ...
            <div class="col-md-4 py-3 p-3">
            <div class="product-top">
                <img src="image/cake1.jfif" alt=""style="width: 15rem; height: 15rem;">
                <div class="overlay-right">
                    <button type="button" class=" btn btn-secondary" title="quick shop">
                    <i class="bi bi-eye-fill"></i>
                    </button>
            ...
            <div class="col-md-4 py-3 p-3">
            <div class="product-top">
                <img src="image/cake2.jpg" alt="" style="width: 15rem; height: 15rem;">
                <div class="overlay-right">
                    <button type="button" class=" btn btn-secondary" title="quick shop">
                    <i class="bi bi-eye-fill"></i>
                    </button>
            ...
            <div class="col-md-4 py-3 p-3">
            <div class="product-top">
                <img src="image/cake4.jpg" alt="" style="width: 15rem; height: 15rem;">
                <div class="overlay-right">
                    <button type="button" class=" btn btn-secondary" title="quick shop">
                    <i class="bi bi-eye-fill"></i>
                    </button>
